class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.10/atelier-linux-x64.tar.gz"
      sha256 "8db223dac005aa747fd2d302de561fe06f34d9a50af275954c62234661561211"
    end
  end
