class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.6/atelier-linux-x64.tar.gz"
      sha256 "25fd70b5dc0878335ccfd8e2e5d065b63cbf5a7b1ca19516767319c30d6374c9"
    end
  end
