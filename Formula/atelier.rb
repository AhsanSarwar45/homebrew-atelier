class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.7/atelier-linux-x64.tar.gz"
      sha256 "2f9544735f5c491813b3cd6e29a1f4f05458919fbf657f41c41468f8e02b4d55"
    end
  end
