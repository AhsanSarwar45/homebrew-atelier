class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.8/atelier-linux-x64.tar.gz"
      sha256 "2943d20c9fc2d782a64c8d9cb8a6187bbca5b5d497820b7c8535b2631e9df8ee"
    end
  end
