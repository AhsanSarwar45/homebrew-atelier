class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.5/atelier-linux-x64.tar.gz"
      sha256 "120ccd7432ff8c893939363a2fb2ba899a4b71e9e2daf320552cc639ca155ebf"
    end
  end
