class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.18/atelier-linux-x64.tar.gz"
      sha256 "2894585c8957f11e92d1e0a081049e0fa25ede00d605f5d717af6460762989de"
    end
  end
