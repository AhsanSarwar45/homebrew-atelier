class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.11/atelier-linux-x64.tar.gz"
      sha256 "35317e64b397100c49602cc4cc92b7591779837ef44225c292adb3018ef7d43c"
    end
  end
