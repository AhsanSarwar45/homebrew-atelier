class Atelier < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/AhsanSarwar45/atelier/releases/download/v0.22.9/atelier-linux-x64.tar.gz"
      sha256 "d0b03ffd3b038aa96ce1a7fe18a2d673789fd0063b49443e000e787b409ccb9d"
    end
  end
